...
typedef int (*schedule_sched_sockio_fn_t)(uint32_t sockio_index, int fd,
					  uint32_t epoll_events);
typedef int (*schedule_sched_fileio_fn_t)(uint32_t fileio_index, int fd,
...
typedef struct schedule_fn_t {
	...
	schedule_sched_sockio_fn_t   init_sockio;
	schedule_sched_sockio_fn_t   start_sockio;
	schedule_sched_sockio_fn_t   reset_sockio;
	schedule_sched_fileio_fn_t   init_fileio;
	schedule_sched_fileio_fn_t   start_fileio;
	schedule_sched_fileio_fn_t   reset_fileio;
