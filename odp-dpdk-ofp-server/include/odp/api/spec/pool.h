...
#define ODP_POOL_SOCK_CONN    ODP_EVENT_SOCKET_CONNECT
#define ODP_POOL_FILE_IO_COMPL ODP_EVENT_FILE_IO_COMPL
#define ODP_POOL_FILE_IO_SUB   ODP_EVENT_FILE_IO_SUB
