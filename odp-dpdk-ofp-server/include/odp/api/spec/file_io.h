...
/* This is an API for doing file/disk IO in ODP.  Currently this assumes using
 * the POSIX API for doing file IO using fd's.
 *
...
// Define a simple set of control flags for how the fileio
// will work.
typedef enum {
...
// Post a read or write asynchronously.
...
// Mixing of these types is allowed, but the application has to 
