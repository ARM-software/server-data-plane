Mutilate modified for server-data-plane memcached
=================================================
...
generation.  This version of mutilate has been lightly modified to measure the
tail latency on all connections being driven into the server instead of just
the measurement thread and connections.  This accounts for the fact that all
connections should abide by the SLA being defined and tested for.
