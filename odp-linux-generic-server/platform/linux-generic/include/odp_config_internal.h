 ...
 */
#define ODP_CONFIG_PACKET_HEADROOM 0 //66
 ...
 * this value.
 */
#define ODP_CONFIG_PACKET_SEG_LEN_MIN (256) //(1598)
...
/** Define a max number of events to allow epoll to return (random number) */
